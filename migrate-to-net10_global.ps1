...
'@
	...
	@{ Old = 'using SsidArqNet.Ateka.AspNetCoreApi;'; New = 'using SsidArqNet.Ateka.AspNetCore.Api.Extensions;' },
	@{ Old = 'using SsidArqNet.Ateka.AspNetCoreApi.Swagger;'; New = 'using SsidArqNet.Ateka.AspNetCore.Api.Swagger;' },
    @{
...
'@
	...
	@{ Old = 'userContextWrapper.IsAtekaAutenticated'; New= 'Task.Run(() => userContextWrapper.IsAtekaAutenticatedAsync()).Result' },
	@{ Old = 'UseSwaggerAtekaFromSettings'; New= 'UseSsidArqNetSwaggerAteka'},
	@{ Old = 'ConfigurarAspNetCoreUserContext'; new = 'AddSsidArqNetAspNetCoreUserContext' },
	@{ Old = 'AddSsidArqNetApiAuthenticationFromAppSettings'; new = 'AddSsidArqNetApiAuthenticationFromAppSettings' },
	@{ Old = 'SsidArqNet.Ateka.UserContext.AspNetCore.Extensions'; New = 'SsidArqNet.Ateka.AspNetCore.UserContext.Extensions' }
    )
